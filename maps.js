  ...
  ["cc1e"],
  {
    QJ7E: function (t, e, n) {
      ...
      var J,
        ...
        rt = {
          ...
          polygonEnd: function () {
            var t = +nt;
            it.add(t < 0 ? O + t : t),
              (this.lineStart = this.lineEnd = this.point = H);
          },
          sphere: function () {
            it.add(O);
          },
      ...
      function st(t, e) {
        ...
        var n = (t *= L) - Q,
          ...
          s = $ * o + u * I(r),
          c = u * i * V(r);
        nt.add(T(c, s)), (Q = t), ($ = o), (tt = a);
      }
      var ct = function (t) {
        return it.reset(), et(t, rt), 2 * it;
      };
      function lt(t) {
        return [T(t[1], t[0]), B(t[2])];
      }
      function ht(t) {
        var e = t[0],
          n = t[1],
          i = I(n);
        return [i * I(e), i * V(e), V(n)];
      }
      function pt(t, e) {
      ...
      var Ft,
        ...
        ee = function (t) {
          ...
          if (
            ...
            for (jt.sort(Vt), e = 1, o = [(i = jt[0])]; e < n; ++e)
              At(i, (r = jt[e])[0]) || At(i, r[1])
                ? (zt(i[0], r[1]) > zt(i[0], i[1]) && (i[1] = r[1]),
                  zt(r[0], i[1]) > zt(i[0], i[1]) && (i[0] = r[0]))
                : o.push((i = r));
            for (
              a = -1 / 0, e = 0, i = o[(n = o.length - 1)];
              e <= n;
              i = r, ++e
            )
              (r = o[e]),
                (u = zt(i[1], r[0])) > a && ((a = u), (mt = r[0]), (bt = i[1]));
          }
          return (
            (jt = Ot = null),
            mt === 1 / 0 || yt === 1 / 0
      ...
      function re(t, e, n) {
        (kt += (t - kt) / ++Ft), (Bt += (e - Bt) / Ft), (Wt += (n - Wt) / Ft);
      }
      function oe() {
        ne.point = ae;
      }
      ...
      function he(t, e) {
        ...
        var n = I(e);
        (Qt = n * I(t)), ($t = n * V(t)), (te = V(e)), re(Qt, $t, te);
      }
      function pe(t, e) {
        t *= L;
        var n = I((e *= L)),
      ...
      var fe = function (t) {
          (Ft = Rt = kt = Bt = Wt = Ht = Zt = qt = Xt = Yt = Ut = 0), et(t, ne);
          var e = Xt,
            n = Yt,
            i = Ut,
            r = e * e + n * n + i * i;
      ...
      function Pe(t, e) {
        ...
        function a(t, e) {
          var a = I(e),
            ...
            c = V(e),
            l = c * n + u * i;
          return [T(s * r - l * o, u * n - c * i), B(l * r + s * o)];
        }
        return (
          (a.invert = function (t, e) {
            var a = I(e),
              ...
              c = V(e),
              l = c * r - s * o;
            return [T(s * r + c * o, u * n + l * i), B(l * n - u * i)];
          }),
          a
        );
      }
      ...
      function _e(t, e, n, i, r, o) {
        if (n) {
          ...
          for (var c, l = r; i > 0 ? l > o : l < o; l -= s)
            (c = lt([a, -u * I(l), -u * V(l)])), t.point(c[0], c[1]);
        }
      }
      function Me(t, e) {
        ((e = ht(e))[0] -= t), vt(e);
          ...
          return (
            (a.center = function (t) {
              return arguments.length
                ? ((n = "function" == typeof t ? t : de([+t[0], +t[1]])), a)
                : n;
            }),
            (a.radius = function (t) {
              return arguments.length
                ? ((i = "function" == typeof t ? t : de(+t)), a)
                : i;
            }),
            (a.precision = function (t) {
              return arguments.length
                ? ((r = "function" == typeof t ? t : de(+t)), a)
                : r;
            }),
            a
          );
      ...
      var Le = function (t, e, n, i, r) {
        ...
        if (
          ...
          for (s.sort(e), Ce(u), Ce(s), o = 0, a = s.length; o < a; ++o)
            s[o].e = n = !n;
          for (var c, l, h = u[0]; ; ) {
      ...
      var Ee = m();
      function Te(t) {
        return C(t[0]) <= M ? t[0] : A(t[0]) * (((C(t[0]) + M) % O) - M);
      }
      var Ie = function (t, e) {
          var n = Te(e),
            i = e[1],
      ...
      var Ne = Array.prototype,
        ze =
          ...
          function (t, e, n) {
            ...
            for (
              var i = -1,
                r = 0 | Math.max(0, Math.ceil((e - t) / n)),
                o = new Array(r);
              ++i < r;
        ...
        return function (r) {
          var o,
            ...
            p = {
              ...
              polygonEnd: function () {
                (p.point = f), (p.lineStart = g), (p.lineEnd = v), (a = Ve(a));
                var t = Ie(o, i);
                a.length
      ...
      function Re(t, e) {
        return (
          ((t = t.x)[0] < 0 ? t[1] - x - S : x - t[1]) -
          ((e = e.x)[0] < 0 ? e[1] - x - S : x - e[1])
        );
      }
      var ke = Ae(
        function () {
        ...
        return function (a) {
          ...
          function M(o, a) {
            ...
            if ((c && l.push([o, a]), m))
              ...
              var s = [
                  (d = Math.max(Ze, Math.min(He, d))),
                  (g = Math.max(Ze, Math.min(He, g))),
                ],
                P = [
                  (o = Math.max(Ze, Math.min(He, o))),
                  (a = Math.max(Ze, Math.min(He, a))),
                ];
              We(s, P, t, e, n, i)
      ...
      function tn(t, e) {
        (Xe = t *= L), (Ye = V((e *= L))), (Ue = I(e)), (Qe.point = en);
      }
      function en(t, e) {
        t *= L;
        var n = V((e *= L)),
          ...
          u = Ue * n - Ye * i * o,
          s = Ye * n + Ue * i * o;
        Ke.add(T(F(a * a + u * u), s)), (Xe = t), (Ye = n), (Ue = i);
      }
      var nn = function (t) {
      ...
      var Pn,
            ...
            v = d
              ? function (t) {
                  var e = V((t *= d)) / g,
                    ...
                    r = n * h + e * f,
                    o = n * u + e * c;
                  return [T(r, i) * w, T(o, F(i * i + r * r)) * w];
                }
              : function () {
                  return [n * w, i * w];
                };
        ...
        Ln = {
          ...
          lineEnd: H,
          polygonStart: function () {
            (Ln.lineStart = Cn), (Ln.lineEnd = In);
          },
          polygonEnd: function () {
            (Ln.lineStart = Ln.lineEnd = Ln.point = H),
              On.add(C(wn)),
              wn.reset();
          },
          result: function () {
          ...
          switch (this._point) {
            ...
            default:
              this._context.moveTo(t + this._radius, e),
                this._context.arc(t, e, this._radius, 0, O);
          }
        },
        result: H,
      };
      ...
      function yi(t, e) {
        (fi -= t), (di -= e), gi.add(F(fi * fi + di * di)), (fi = t), (di = e);
      }
      var bi = vi;
      function Pi() {
        this._string = [];
      ...
      var _i = function (t, e) {
          ...
          return (
            ...
            (o.projection = function (e) {
              return arguments.length
                ? ((n = null == e ? ((t = null), jn) : (t = e).stream), o)
                : t;
            }),
            ...
            (o.pointRadius = function (t) {
              return arguments.length
                ? ((r = "function" == typeof t ? t : (i.pointRadius(+t), +t)),
                  o)
                : r;
            }),
          ...
          return +e
            ? (function (t, e) {
                ...
                return function (e) {
                  ...
                  function _() {
                    n(l, h, c, p, f, d, r, o, i, a, u, s, Ti, e),
                      (g.lineEnd = b),
                      b();
                  }
                  return g;
      ...
      function Vi(t) {
        ...
        return (
          ...
          (j.precision = function (t) {
            return arguments.length ? ((a = Gi(u, (x = t * t))), E()) : F(x);
          }),
          ...
          function () {
            return (
              (e = t.apply(this, arguments)), (j.invert = e.invert && O), C()
            );
          }
        );
      }
      ...
      var Ri = function () {
          return Ai(Fi).scale(155.424).center([0, 33.6442]);
        },
        ki = function () {
          return Ri()
            .parallels([29.5, 45.5])
        ...
        return (
          (l.invert = function (t) {
            var e = a.scale(),
              ...
              i = (t[0] - n[0]) / e,
              r = (t[1] - n[1]) / e;
            return (r >= 0.12 && r < 0.234 && i >= -0.425 && i < -0.214
              ? u
          ...
          (l.precision = function (t) {
            return arguments.length
              ? (a.precision(t), u.precision(t), s.precision(t), h())
              : a.precision();
          }),
          (l.scale = function (t) {
            return arguments.length
      ...
      function $i(t, e) {
        var n = I(t),
          i = t === e ? V(t) : N(n / I(e)) / N(Qi(e) / Qi(t)),
          r = (n * z(Qi(t), i)) / i;
        if (!i) return Ui;
        function o(t, e) {
          r > 0 ? e < -x + S && (e = -x + S) : e > x - S && (e = x - S);
          var n = r / z(Qi(e), i);
          return [n * V(i * t), r - n * I(i * t)];
        }
        return (
          (o.invert = function (t, e) {
            var n = r - e,
              o = A(i) * F(t * t + n * n);
            return [(T(t, C(n)) / i) * A(n), 2 * E(z(r / o, 1 / i)) - x];
          }),
          o
        );
      }
      var tr = function () {
        return Ai($i).scale(109.5).parallels([30, 30]);
      };
      function er(t, e) {
        return [t, e];
      }
      ...
      function ir(t, e) {
        ...
        function o(t, e) {
          var n = r - e,
            o = i * t;
          return [n * V(o), r - n * I(o)];
        }
        return (
          (o.invert = function (t, e) {
            var n = r - e;
            return [(T(t, C(n)) / i) * A(n), r - A(i) * F(t * t + n * n)];
          }),
          o
        );
      }
      var rr = function () {
          return Ai(ir).scale(131.154).center([0, 13.9389]);
        },
        or = 1.340264,
        ar = -0.081106,
        ur = 893e-6,
      ...
      function lr(t, e) {
        var n = B(cr * V(e)),
          ...
          r = i * i * i;
        return [
          (t * I(n)) / (cr * (or + 3 * ar * i + r * (7 * ur + 9 * sr * i))),
          n * (or + ar * i + r * (ur + sr * i)),
        ];
      }
      lr.invert = function (t, e) {
        ...
        return [
          (cr * t * (or + 3 * ar * r + o * (7 * ur + 9 * sr * r))) / I(i),
          B(V(i) / cr),
        ];
      };
      var hr = function () {
      ...
      var gr = function () {
        ...
        return (o = {
          ...
          scale: function (t) {
            return arguments.length
              ? ((h = dr((a = +t) * c, a * l, u, s)), d())
              : a;
          },
          translate: function (t) {
            return arguments.length
              ? ((h = dr(a * c, a * l, (u = +t[0]), (s = +t[1]))), d())
              : [u, s];
          },
          reflectX: function (t) {
            return arguments.length
              ? ((h = dr(a * (c = t ? -1 : 1), a * l, u, s)), d())
              : c < 0;
          },
          reflectY: function (t) {
            return arguments.length
              ? ((h = dr(a * c, a * (l = t ? -1 : 1), u, s)), d())
              : l < 0;
          },
      ...
      vr.invert = function (t, e) {
        ...
        do {
          ...
          i -= n =
            ...
            (1.007226 +
              o *
                (0.045255 + a * (0.259866 * o - 0.311325 - 0.005916 * 11 * a)));
        } while (C(n) > S && --r > 0);
        return [
          t /
            (0.8707 +
      ...
      var Mr = function () {
            ...
            (e.prototype.updateExtremes = function () {
              ...
              if (t) {
                ...
                r != this.north && ((this._north = v.round(r, 6)), (a = !0)),
                  ...
                  this._east < this._west &&
                    ((this._east = 180), (this._west = -180)),
        ...
        jr = (function (t) {
          ...
          return (
            ...
            Object.defineProperty(e.prototype, "north", {
              get: function () {
                return g.isNumber(this._northDefined)
                  ? this._northDefined
                  : this._north;
              },
              set: function (t) {
            ...
            Object.defineProperty(e.prototype, "south", {
              get: function () {
                return g.isNumber(this._southDefined)
                  ? this._southDefined
                  : this._south;
              },
              set: function (t) {
            ...
            Object.defineProperty(e.prototype, "west", {
              get: function () {
                return g.isNumber(this._westDefined)
                  ? this._westDefined
                  : this._west;
              },
              set: function (t) {
            ...
            Object.defineProperty(e.prototype, "east", {
              get: function () {
                return g.isNumber(this._eastDefined)
                  ? this._eastDefined
                  : this._east;
              },
              set: function (t) {
              ...
              if (g.hasValue(e.geodata) && g.isString(e.geodata)) {
                ...
                if (g.hasValue(window["am4geodata_" + e.geodata]))
                  ...
                  try {
                    ...
                    throw Error(
                      "MapChart error: Geodata `" +
                        n +
                        "` is not loaded or is incorrect."
                    );
                  }
              }
      ...
      (d.c.registeredClasses.MapSeries = jr),
        (d.c.registeredClasses.MapSeriesDataItem = xr);
      var Or = n("C6dT"),
        wr = (function (t) {
          function e() {
            var e = t.call(this) || this;
            ...
            (e.prototype.showTooltip = function (e) {
              ...
              return (
                n &&
                  ...
                  !this.series.chart.events.has(
                    "mappositionchanged",
                    this.handleTooltipMove,
                    this
                  ) &&
                  this.series.chart.events.on(
                    "mappositionchanged",
                    this.handleTooltipMove,
                    this
                  ),
        ...
        return (
          ...
          (e.prototype.validatePosition = function () {
            if (g.isNumber(this.latitude) && g.isNumber(this.longitude)) {
              var e = this.series.chart.projection.d3Projection([
                  this.longitude,
                  this.latitude,
                ]),
      ...
      var Wr = (function (t) {
        function e() {
          ...
          (e.className = "MapPolygon"),
            ...
            e.setPropertyValue("precision", 0.5);
          var n = new p.a();
          return (
        ...
        return (
          ...
          Object.defineProperty(e.prototype, "multiGeoPolygon", {
            get: function () {
              ...
              return (
                !t && this.dataItem && (t = this.dataItem.multiGeoPolygon), t
              );
            },
            set: function (t) {
              this.setPropertyValue("multiGeoPolygon", t, !0),
                (this.multiPolygon = Rr(t));
            },
            enumerable: !0,
            configurable: !0,
          }),
          Object.defineProperty(e.prototype, "multiPolygon", {
            ...
            set: function (t) {
              this.setPropertyValue("multiPolygon", t) &&
                (this.updateExtremes(), this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
          }),
      ...
      var Hr = n("vMqJ"),
        ...
        Xr = (function (t) {
          function e() {
            var e = t.call(this) || this;
            return (
              (e.className = "MapPolygonSeriesDataItem"), e.applyTheme(), e
            );
          }
          return (
            Object(c.c)(e, t),
                      ...
                      var i = function (t, e) {
                          ...
                          if (o) {
                            ...
                            if (
                              ...
                              var s = o.coordinates;
                              s && "Polygon" == a && (s = [s]);
                              var c = Ir.find(r.data, function (t, e) {
                                return t.id == u;
                              });
                              c
            ...
            (e.prototype.validate = function () {
              t.prototype.validate.call(this),
                ...
                this.mapPolygons.each(function (t) {
                  t.validate(),
                    t.zIndex ||
                      t.propertyFields.zIndex ||
                      (t.zIndex = 1e6 - t.boxArea);
                });
            }),
      ...
      (d.c.registeredClasses.MapPolygonSeries = Yr),
        (d.c.registeredClasses.MapPolygonSeriesDataItem = Xr);
      var Ur = (function () {
        function t() {
            ...
            if (t) {
              for (
                ...
                if (c.length > 1) {
                  ...
                  1 == c.length && ((a = c[0]), (u = c[0]), (r = 0), (o = 1));
              }
              if (a && u) {
                var h = (e - r) / (o - r);
          ...
          return (
            ...
            (e.prototype.updateRectangle = function () {
              ...
              var i = Math.min(this.percentWidth, this.percentHeight) / 100,
                r = t.seriesContainer;
              (n.x =
                Math.ceil((-r.pixelX * i) / e) + this.seriesContainer.pixelX),
                (n.y =
                  Math.ceil((-r.pixelY * i) / e) + this.seriesContainer.pixelY),
                n.validate();
            }),
            (e.prototype.updateMapSize = function () {
              if (this.chart) {
                var t =
                  (this.chart.scaleRatio *
                    Math.min(this.percentWidth, this.percentHeight)) /
                  100;
                ...
                e.width > 0 && (this.rectangle.visible = !0),
                  (this.seriesContainer.x =
                    this.pixelWidth / 2 - e.x * t - (e.width / 2) * t),
                  (this.seriesContainer.y =
                    this.pixelHeight / 2 - e.y * t - (e.height / 2) * t),
                  this.updateRectangle(),
                  this.afterDraw();
              }
            }),
                    ...
                    var r = function (t, e) {
                        ...
                        if (r) {
                          ...
                          if ("Point" == a || "MultiPoint" == a) {
                            ...
                            var s = r.coordinates;
                            "Point" == a && (s = [s]);
                            var c = Ir.find(o.data, function (t, e) {
                              return t.id == u;
                            });
                            c
      ...
      (d.c.registeredClasses.MapImageSeries = so),
        (d.c.registeredClasses.MapImageSeriesDataItem = uo);
      var co = n("Rnbi"),
        lo = n("jfaP"),
        ho = n("tjMS"),
        po = (function (t) {
          function e() {
            ...
            (e._imageListeners = {}),
              ...
              (e.line.parent = e),
              (e.strokeOpacity = 1),
              e.setPropertyValue("precision", 0.1);
            var n = new p.a();
            return (
              (e.stroke = n.getFor("grid")),
          ...
          return (
            ...
            (e.prototype.positionToPoint = function (t) {
              return this.shortestDistance
                ? this.series.chart.projection.positionToPoint(
                    this.multiGeoLine,
                    t
                  )
                : this.line
            ...
            Object.defineProperty(e.prototype, "multiLine", {
              get: function () {
                ...
                return (
                  !t &&
                    this.dataItem &&
                    this.dataItem.multiLine &&
                    (t = this.dataItem.multiLine),
                  t
                );
              },
              set: function (t) {
                this.setPropertyValue("multiLine", t),
                  (this.multiGeoLine = Dr(t));
              },
              enumerable: !0,
              configurable: !0,
            }),
            ...
            (e.prototype.validate = function () {
              ...
              if (this.multiLine) {
                if (this.shortestDistance)
                  ...
                  for (
                    var n = [], i = 0, r = this.multiLine.length;
                    i < r;
                    i++
                  ) {
                    for (
                      var o = this.multiLine[i], a = [], u = 0, s = o.length;
                      u < s;
                      u++
                    ) {
                      var c = o[u],
              ...
              get: function () {
                return (
                  this._lineObjects ||
                    ...
                    this._lineObjects.events.on(
                      "inserted",
                      this.handleLineObjectAdded,
                      this,
                      !1
                    ),
      ...
      var fo = (function (t) {
          ...
          return (
            ...
            Object.defineProperty(e.prototype, "geoLine", {
              ...
              set: function (t) {
                (this._geoLine = t), (this.multiLine = Fr([t]));
              },
              enumerable: !0,
              configurable: !0,
            }),
            Object.defineProperty(e.prototype, "multiGeoLine", {
              ...
              set: function (t) {
                (this._multiGeoLine = t), (this.multiLine = Fr(t));
              },
              enumerable: !0,
              configurable: !0,
            }),
      ...
      (d.c.registeredClasses.MapLineSeries = go),
        (d.c.registeredClasses.MapLineSeriesDataItem = fo);
      var vo = (function (t) {
        function e() {
          var e = t.call(this) || this;
          return (
            (e.className = "Graticule"),
            e.applyTheme(),
            (e.shortestDistance = !0),
            e
          );
        ...
        yo = (function (t) {
          ...
          return (
            ...
            Object.defineProperty(e.prototype, "latitudeStep", {
              ...
              set: function (t) {
                this.setPropertyValue("latitudeStep", t) &&
                  this.invalidateData();
              },
              enumerable: !0,
              configurable: !0,
            ...
            Object.defineProperty(e.prototype, "longitudeStep", {
              ...
              set: function (t) {
                this.setPropertyValue("longitudeStep", t) &&
                  this.invalidateData();
              },
              enumerable: !0,
              configurable: !0,
            ...
            Object.defineProperty(e.prototype, "singleSprite", {
              ...
              set: function (t) {
                this.setPropertyValue("singleSprite", t) &&
                  this.invalidateData();
              },
              enumerable: !0,
              configurable: !0,
      ...
      (d.c.registeredClasses.GraticuleSeries = yo),
        (d.c.registeredClasses.GraticuleSeriesDataItem = mo);
      var bo = n("zhwk"),
        Po = (function (t) {
          function e() {
            var e = t.call(this) || this;
        ...
        So = (function (t) {
          function e() {
            ...
            (r.fillOpacity = 0),
              r.events.on(
                "down",
                function (t) {
                  e.seriesContainer.dragStart(
                    t.target.interactions.downPointers.getIndex(0)
                  );
                },
                e
              ),
          ...
          return (
            ...
            (e.prototype.handlePanUp = function (t) {
              this._downPointOrig && this.panSprite.dragStop(t.pointer),
                (this._downPointOrig = void 0);
            }),
            (e.prototype.handlePanMove = function () {
              if (!this.seriesContainer.isResized) {
                if (
                  Object(bo.b)().areTransformed([
                    this.panSprite.interactions,
                    this.seriesContainer.interactions,
                  ])
                )
                  return;
              ...
              if (this.backgroundSeries) {
                ...
                this.series.each(function (r) {
                  ...
                  (t > o.x || !g.isNumber(t)) && (t = o.x),
                    (e < o.x + o.width || !g.isNumber(e)) &&
                      (e = o.x + o.width),
                    (n > o.y || !g.isNumber(n)) && (n = o.y),
                    (i < o.y + o.height || !g.isNumber(i)) &&
                      (i = o.y + o.height);
                });
              (this.seriesMaxLeft = t),
                ...
                this.seriesWidth > 0 && this.seriesHeight > 0
                  ? ((this.chartContainer.visible = !0),
                    ...
                    (this._zoomGeoPointReal &&
                      g.isNumber(this._zoomGeoPointReal.latitude)) ||
            ...
            (e.prototype.applyInternalDefaults = function () {
              t.prototype.applyInternalDefaults.call(this),
                g.hasValue(this.readerTitle) ||
                  (this.readerTitle = this.language.translate("Map")),
                g.hasValue(this.background.readerTitle) ||
                  (this.background.readerTitle = this.language.translate(
            ...
            (e.prototype.handleWheel = function (t) {
              ...
              t.shift.y < 0
                ? this.zoomIn(
                    i,
                    void 0,
                    this.interactions.mouseOptions.sensitivity
                  )
                : this.zoomOut(
                    i,
                    void 0,
            ...
            Object.defineProperty(e.prototype, "panBehavior", {
              ...
              set: function (t) {
                if (this.setPropertyValue("panBehavior", t)) {
                  ...
                  switch (
                    ((this.panSprite.draggable = !1), (e.draggable = !1), t)
                  ) {
                    case "move":
                      e.draggable = !0;
                      break;
            ...
            (e.prototype.zoomToGeoPoint = function (t, e, n, i, r) {
              var o = this;
              if (
                (t || (t = this.zoomGeoPoint),
                t && g.isNumber(t.longitude) && g.isNumber(t.latitude))
              ) {
                ...
                if (a) {
                  ...
                  n &&
                    (s = { x: this.innerWidth / 2, y: this.innerHeight / 2 }),
                  ...
                  return (
                    !r &&
                      ...
                      ((c =
                        this.innerWidth / 2 -
                        (this.seriesMaxLeft +
                          (this.seriesMaxRight - this.seriesMaxLeft) / 2) *
                          e *
                          this.scaleRatio),
                      (l =
                        this.innerHeight / 2 -
                        (this.seriesMaxTop +
                          (this.seriesMaxBottom - this.seriesMaxTop) / 2) *
                          e *
                          this.scaleRatio)),
            ...
            (e.prototype.zoomToMapObject = function (t, e, n, i) {
              ...
              var o = t.dataItem;
              if (
                (o && g.isNumber(o.zoomLevel) && (e = o.zoomLevel),
                t instanceof Wr)
              ) {
                var a = t.dataItem,
                  u = t.polygon.bbox;
                (0 != u.width && 0 != u.height) ||
                  (u = t.polygon.group.getBBox()),
                  g.isNumber(e) ||
                    (e = Math.min(
                      this.seriesWidth / u.width,
                      this.seriesHeight / u.height
                    ));
                var s = void 0;
            ...
            (e.prototype.zoomToRectangle = function (t, e, n, i, r, o, a) {
              ...
              var u =
                r *
                Math.min(
                  (this.south - this.north) / (n - t),
                  (this.west - this.east) / (i - e)
                );
            ...
            Object.defineProperty(e.prototype, "zoomGeoPoint", {
              get: function () {
                var t = Zr.spritePointToSvg(
                  { x: this.pixelWidth / 2, y: this.pixelHeight / 2 },
                  this
                );
              ...
              this.zoomLevel != this._prevZoomLevel &&
                ...
                this.svgContainer.readerAlert(
                  this.language.translate(
                    ...
                    g.castString(this.zoomLevel)
                  )
                )),
                !this.zoomGeoPoint ||
                  (this._prevZoomGeoPoint.latitude ==
                    this.zoomGeoPoint.latitude &&
                    this._prevZoomGeoPoint.longitude ==
                      this.zoomGeoPoint.longitude) ||
            ...
            Object.defineProperty(e.prototype, "deltaGamma", {
              ...
              set: function (t) {
                (t = v.round(t, 3)),
                  this.setPropertyValue("deltaGamma", t) &&
                    (this.rotateMap(), this.updateZoomGeoPoint());
              },
              enumerable: !0,
              configurable: !0,
      ...
      (d.c.registeredClasses.MapSplineSeries = wo),
        (d.c.registeredClasses.MapSplineSeriesDataItem = Oo);
      var Lo = (function (t) {
          function e() {
            var e = t.call(this) || this;
      ...
      (d.c.registeredClasses.MapArcSeries = Co),
        (d.c.registeredClasses.MapArcSeriesDataItem = Lo);
      var Eo = n("aGXA"),
        To = n("CnhP"),
        Io = (function (t) {
          function e() {
            ...
            return (
              ...
              (e.thumb.readerTitle = e.language.translate(
                "Use arrow keys to zoom in and out"
              )),
              (e.minusButton.readerTitle = e.language.translate(
                "Press ENTER to zoom in"
              )),
              (e.plusButton.readerTitle = e.language.translate(
          ...
          return (
            ...
            (e.prototype.updateThumb = function () {
              ...
              if (!n.isDown) {
                var i =
                  (Math.log(e.zoomLevel) - Math.log(this.chart.minZoomLevel)) /
                  Math.LN2;
                "vertical" == this.layout
                  ? (n.y =
                      t.pixelHeight -
            ...
            (e.prototype.handleThumbDrag = function () {
              ...
              t =
                ...
                (t =
                  "vertical" == this.layout
                    ? (this.stepCount *
                        (e.pixelHeight - i.pixelY - i.pixelHeight)) /
      ...
      d.c.registeredClasses.ZoomControl = Io;
      var Go = (function (t) {
        function e() {
          var e = t.call(this) || this;
      ...
      la.invert = function (t, e) {
        ...
        var n = 1 + t * t + e * e,
          ...
          s = u * u - a * a;
        return [
          2 * Ho(t) * zo(ua(o) * a, 0.25 - s),
          2 * Ho(e) * zo(u * Zo(r), 0.25 + s),
        ];
      };
      var ha = aa(8),
        pa = Ro(1 + $o);
      function fa(t, e) {
        ...
        return n < Ko
          ...
          : [
              t * Vo(n) * (2 * $o - 1 / Zo(n)),
              Ho(e) * (2 * $o * (n - Ko) - Ro(qo(n / 2))),
            ];
      }
      fa.invert = function (t, e) {
        if ((i = Do(e)) < pa) return [t, 2 * No(Ao(e)) - Jo];
        var n,
          i,
          r = Ko,
          o = 25;
        ...
        return [t / (Vo(r) * (ha - 1 / Zo(r))), Ho(e) * r];
      };
      function da(t, e) {
        return [(t * Vo(e)) / Vo((e /= 2)), 2 * Zo(e)];
      }
      da.invert = function (t, e) {
        var n = 2 * ra(e / 2);
        return [(t * Vo(n / 2)) / Vo(n), n];
      };
      function ga(t, e, n) {
        var i,
          r,
      ...
      function ma(t, e, n) {
        function i(i, r) {
          return [t * i * Vo((r = va(n, r))), e * Zo(r)];
        }
        return (
          (i.invert = function (i, r) {
            return (
              (r = ra(r / e)), [i / (t * Vo(r)), ra((2 * r + Zo(2 * r)) / n)]
            );
          }),
          i
        );
      ...
      function Sa(t, e) {
        var n = va(Uo, e);
        return [(ba * t) / (1 / Vo(e) + Pa / Vo(n)), (e + $o * Zo(n)) / ba];
      }
      Sa.invert = function (t, e) {
        ...
        do {
          (i = r - $o * Zo(o)),
            (o -= n =
              (Zo(2 * o) + 2 * o - Uo * Zo(i)) /
              (2 * Vo(2 * o) + 2 + Uo * Vo(i) * $o * Vo(o)));
        } while (Do(n) > Xo && --a > 0);
        return (i = r - $o * Zo(o)), [(t * (1 / Vo(i) + Pa / Vo(o))) / ba, i];
      };
      function _a(t, e) {
        return [t * Vo(e), e];
      }
      ...
      var xa = aa(3);
      function ja(t, e) {
        return [(xa * t * (2 * Vo((2 * e) / 3) - 1)) / ta, xa * ta * Zo(e / 3)];
      }
      ja.invert = function (t, e) {
        var n = 3 * ra(e / (xa * ta));
        return [(ta * t) / (xa * (2 * Vo((2 * n) / 3) - 1)), n];
      };
      function Oa(t) {
        var e = Vo(t);
        function n(t, n) {
      ...
      function Ta(t, e) {
        return [(t * (1 + Vo(e))) / aa(2 + Uo), (2 * e) / aa(2 + Uo)];
      }
      ...
      function Ia(t, e) {
        for (
          var n = (1 + Jo) * Zo(e), i = 0, r = 1 / 0;
          i < 10 && Do(r) > Xo;
          i++
        )
          e -= r = (e + Zo(e) - n) / (1 + Vo(e));
        return (n = aa(2 + Uo)), [(t * (1 + Vo(e))) / n, (2 * e) / n];
      }
      Ia.invert = function (t, e) {
        var n = 1 + Jo,
          i = aa(n / 2);
        return [(2 * t * i) / (1 + Vo((e *= i))), ra((e + Zo(e)) / n)];
      };
      var Ga = function () {
          return zi(Ia).scale(173.044);
        },
        Da = 3 + 2 * $o;
      function Na(t, e) {
        var n = Zo((t /= 2)),
      ...
      Na.invert = function (t, e) {
        ...
        do {
          ...
          var z = (_ * I - S * D) / N,
            V = (S * G - _ * T) / N;
          (i -= z), (r = ko(-Jo, Bo(Jo, r - V)));
        } while ((Do(z) > Xo || Do(V) > Xo) && --o > 0);
      ...
      function Aa(t, e) {
        var n = e / 2,
          i = Vo(n);
        return [((2 * t) / ta) * Vo(e) * i * i, ta * qo(n)];
      }
      Aa.invert = function (t, e) {
        var n = No(e / ta),
          i = Vo(n),
          r = 2 * n;
        return [(t * ta) / 2 / (Vo(r) * i * i), r];
      };
      var Fa = function (t, e, n, i, r, o, a, u) {
        function s(s, c) {
          ...
          var l = c * c,
            ...
            f = (h * h + p * p) / (2 * p),
            d = (s * ra(h / f)) / Uo;
          return [f * Zo(d), c * (1 + l * u) + f * (1 - Vo(d))];
        }
        return (
          ...
          (s.invert = function (s, c) {
            ...
            do {
              var g = f * f,
                ...
                O = r + g * (3 * o + 5 * g * a),
                w =
                  (2 * (v * j + m * (O - 1)) * b - y * (2 * (O - 1))) / (b * b),
                L = Vo(M),
                C = Zo(M),
                E = P * L,
                T = P * C,
                I = ((p / Uo) * (1 / aa(1 - x / S)) * (j * P - v * w)) / S,
                G = T - s,
                D = f * (1 + g * u) + P - E - c,
                N = w * C + E * I,
                z = E * _,
      ...
      Fa(2.8284, -1.6988, 0.75432, -0.18071, 1.76003, -0.38914, 0.042555),
        Fa(
          2.583819,
          -0.835827,
          0.170354,
        ...
        Fa((5 / 6) * Uo, -0.62636, -0.0344, 0, 1.3493, -0.05524, 0, 0.045);
      function Ra(t, e) {
        var n = t * t,
          i = e * e;
        return [
          t * (1 - 0.162388 * i) * (0.87 - 952426e-9 * n * n),
          e * (1 + i / 12),
        ];
      }
      ...
      Fa(2.6516, -0.76534, 0.19123, -0.047094, 1.36289, -0.13965, 0.031762);
      function ka(t, e) {
        var n = Ho(t),
          i = Ho(e),
          r = Vo(e),
        ...
        var s = (function (t, e) {
          ...
          if (t > 0.222 * Uo || (e < Uo / 4 && t > 0.175 * Uo)) {
            if (((n = (v + o * aa(d * (1 + a) - v * v)) / (1 + a)), t > Uo / 4))
              return [n, n];
            var O = n,
              w = 0.5 * n;
            (n = 0.5 * (w + O)), (i = 50);
      ...
      ka.invert = function (t, e) {
        ...
        return (
          a && (s = -Jo - s),
          [n * (zo(Zo(s) * l, -Zo(c)) + Uo), i * ra(Vo(s) * l)]
        );
      };
      function Ba(t, e) {
        var n, i, r, o, a;
        ...
        if (e >= 1 - Xo)
          return (
            ...
            [
              (o = (function (t) {
                return ((t = Ao(2 * t)) - 1) / (t + 1);
              })(t)) +
                (n * ((a = i * ua(t)) - t)) / (i * i),
              r - n * o * r * (a - t),
              r + n * o * r * (a + t),
              2 * No(Ao(t)) - Jo + (n * (a - t)) / i,
            ]
          );
      ...
      Ha.invert = function (t, e) {
        ...
        return [
          zo(o[1], o[0]) / -1,
          2 * No(Ao(-0.5 * Ro(n * o[0] * o[0] + n * o[1] * o[1]))) - Jo,
        ];
      };
      ra(1 - 1 / 3), Oa(0);
      ...
      function Ya(t, e) {
        return Do(e) > Za
          ? (((t = ya(t, e))[1] -= e > 0 ? qa : -qa), t)
          : _a(t, e);
      }
      Ya.invert = function (t, e) {
        return Do(e) > Za
          ? ya.invert(t, e + (e > 0 ? qa : -qa))
          : _a.invert(t, e);
      };
      function Ua(t, e) {
      ...
      var Ja = Uo / $o;
      function Ka(t, e) {
        return [(t * (1 + aa(Vo(e)))) / 2, e / (Vo(e / 2) * Vo(t / 6))];
      }
      Ka.invert = function (t, e) {
        var n = Do(t),
          i = Do(e),
      ...
      function Qa(t, e) {
        ...
        return [
          ...
          e *
            (1.00384 +
              n * (0.0802894 + -0.02855 * i + 199025e-9 * n) +
              i * (0.0998909 + -0.0491032 * i)),
        ];
      }
      Qa.invert = function (t, e) {
        ...
        do {
          var o = n * n,
            ...
            s =
              n *
                (0.975534 + a * (-0.0143059 * o - 0.119161 + -0.0547009 * a)) -
              t,
            c =
              i *
                (1.00384 +
      ...
      tu.invert = function (t, e) {
        return [t, 2.5 * No(Ao(0.8 * e)) - 0.625 * Uo];
      };
      var eu = function () {
      ...
      function ou(t, e) {
        for (
          ...
          o < 25 &&
          ((r -= n = (Zo(r / 2) + Zo(r) - i) / (0.5 * Vo(r / 2) + Vo(r))),
          !(Do(n) < Xo));
          o++
        );
        return [
          (t * (1 + (2 * Vo(r)) / Vo(r / 2))) / (3 * $o),
          (2 * aa(3) * Zo(r / 2)) / aa(2 + $o),
        ];
      }
      ...
      function au(t, e) {
        for (
          var n,
            ...
            a = 0;
          a < 25 &&
          ((o -= n = (o / 2 + Zo(o) - r) / (0.5 + Vo(o))), !(Do(n) < Xo));
          a++
        );
        return [(i * (0.5 + Vo(o)) * t) / 1.5, i * o];
      }
      au.invert = function (t, e) {
        ...
        return (
          ...
          [(1.5 * t) / (n * (0.5 + Vo(i))), ra((i / 2 + Zo(i)) / (1 + Uo / 4))]
        );
      };
      function uu(t, e) {
        var n = e * e,
        ...
        return [
          t *
            (0.84719 -
              0.13063 * n +
              r * r * (0.05494 * n - 0.04515 - 0.02326 * i + 0.00331 * r)),
        ...
        return [
          t /
            (0.84719 -
              ...
              (o = i * (r = i * i)) *
                o *
                (0.05494 * i - 0.04515 - 0.02326 * r + 0.00331 * o)),
          a,
        ];
      };
      function su(t, e) {
        return [(t * (1 + Vo(e))) / 2, 2 * (e - qo(e / 2))];
      }
      ...
      yu.invert = function (t, e) {
        e > 1.790857183
          ? (e = 1.790857183)
          : e < -1.790857183 && (e = -1.790857183);
        var n,
          i = e;
        do {
          var r = i * i;
          i -= n =
            (i * (lu + r * r * (hu + r * (pu + fu * r))) - e) /
            (du + r * r * (gu + r * (vu + mu * r)));
        } while (Do(n) > Xo);
        return [t, i];
      };
      ...
      bu.invert = function (t, e) {
        ...
        return (
          (a = qo(r)),
          [
            (Do(e) < Do(r + 1 / a) ? ra(t * a) : Ho(t) * (oa(Do(t * a)) + Jo)) /
              Zo(r),
            r,
          ]
        );
      ...
      function Ou(t, e) {
        ...
        var n = Do(e / Jo),
          i = ra(n);
        if (Do(t) < Xo || Do(Do(e) - Jo) < Xo)
          return [0, Ho(e) * Uo * qo(i / 2)];
        var r = Vo(i),
          o = Do(Uo / t - t / Uo) / 2,
          a = o * o,
          u = r / (n + r - 1),
      ...
      Ou.invert = function (t, e) {
        ...
        var n = (t /= Uo) * t,
          ...
          c =
            i / s +
            ((2 * u * u * u) / (s * s * s) - (9 * a * u) / (s * s)) / 27,
          l = (a - (u * u) / (3 * s)) / s,
          h = 2 * aa(-l / 3),
          p = oa((3 * c) / (l * h)) / 3;
        return [
          (Uo * (r - 1 + aa(1 + 2 * (n - i) + o))) / (2 * t),
          Ho(e) * Uo * (-h * Vo(p + Uo / 3) - u / (3 * s)),
        ];
      };
      function wu(t, e) {
        if (Do(e) < Xo) return [t, 0];
      ...
      wu.invert = function (t, e) {
        ...
        return [
          ...
          Ho(e) *
            Jo *
            Zo(2 * zo(aa((1 - 2 * i * n) * (i + r) - n), aa(r + i + n))),
        ];
      };
      function Lu(t, e) {
        if (Do(e) < Xo) return [t, 0];
      ...
      var Eu = 4 * Uo + 3 * aa(3),
        Tu = 2 * aa((2 * Uo * aa(3)) / Eu);
      ma((Tu * aa(3)) / Uo, Tu, Eu / 6);
      function Iu(t, e) {
      ...
      d.c.registeredClasses.Orthographic = Vu;
      var Au = (function (t) {
        function e() {
          var e = t.call(this) || this;
      ...
      d.c.registeredClasses.Stereographic = Au;
      var Fu = (function (t) {
        function e() {
          var e = t.call(this) || this;
      ...
      d.c.registeredClasses.Albers = Fu;
      var Ru = (function (t) {
        function e() {
          var e = t.call(this) || this;
          ...
          _down: function (t) {
            for (
              ...
              var o = 1 + (t << 1),
                ...
                u = e[o];
              if (
                (a < this.length && n(e[a], u) < 0 && ((o = a), (u = e[a])),
                n(u, r) >= 0)
              )
                break;
              (e[t] = u), (t = o);
    ...
    U8r1: function (t, e, n) {
      ...
      function r(t, e, n) {
        ...
        var b = (function (t) {
            for (
              var e = 0, n = 0, i = 0, r = t[0], o = 0, u = r.length, s = u - 1;
              o < u;
              s = o++
            ) {
              var c = r[o],
        ...
        (this.x = t),
          ...
          (this.d = (function (t, e, n) {
            for (var i = !1, r = 1 / 0, o = 0; o < n.length; o++)
              for (
                var a = n[o], s = 0, c = a.length, l = c - 1;
                s < c;
                l = s++
              ) {
                var h = a[s],
